package com.neokred.pos.ui.setting.device_config;
...
import com.neokred.pos.common.enums.PaymentType;
import com.neokred.sdk.payment.model.NKCardMode;
...
public class DeviceConfigSelectionViewModel extends BaseViewModel {
    ...
    private void initCardModeList() {
        for (NKCardMode mode : NKCardMode.values()) {
            allCurrencies.add(new DeviceConfigItem(
                    "",
                    mode.name(),
                    R.drawable.ic_transaction_type,
