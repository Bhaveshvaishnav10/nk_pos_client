...
import com.neokred.pos.ui.printer.activities.base.PrinterBaseActivity;
import com.neokred.pos.utils.PrintDialogUtils;
import com.neokred.pos.BR;
import com.neokred.pos.R;
import com.neokred.pos.databinding.ActivityPrintTicketBinding;
...
public class PrintTicketActivity extends PrinterBaseActivity<ActivityPrinterBaseBinding, PrintTicketViewModel> {
    ...
    @Override
    protected void onReturnPrintResult(boolean isSuccess, String status, NKPrinterStatus resultType) {
        ...
        if (isSuccess) {
            ...
            if (isSmallDevices) {
                ...
                if (resultType == NKPrinterStatus.NO_PAPER) {
                    binding.tvFail.setText("No Paper");
                } else if (resultType == NKPrinterStatus.OVERHEATED) {
