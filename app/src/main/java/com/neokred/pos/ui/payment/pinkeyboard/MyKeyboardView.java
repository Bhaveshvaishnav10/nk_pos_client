package com.neokred.pos.ui.payment.pinkeyboard;
...
//            }
            ...
            if (code >= 0) {//number value
                ...
                String locationStr = NKPOSUtil.byteArray2Hex(NKPOSUtil.intToByteArray(ayRandomKey[index])) + NKPOSUtil.byteArray2Hex(NKPOSUtil.intToByteArray(x)) + NKPOSUtil.byteArray2Hex(NKPOSUtil.intToByteArray(y))
                        + NKPOSUtil.byteArray2Hex(NKPOSUtil.intToByteArray(rit)) + NKPOSUtil.byteArray2Hex(NKPOSUtil.intToByteArray(riby));
                s.append(locationStr);
                index++;
            } else {
                if (code == -3) {
                    label = NKPOSUtil.byteArray2Hex(NKPOSUtil.intToByteArray(13));
                } else if (code == -4) {
                    label = NKPOSUtil.byteArray2Hex(NKPOSUtil.intToByteArray(15));
                } else {
                    label = NKPOSUtil.byteArray2Hex(NKPOSUtil.intToByteArray(14));
                }
                String locationStr = label + NKPOSUtil.byteArray2Hex(NKPOSUtil.intToByteArray(x)) + NKPOSUtil.byteArray2Hex(NKPOSUtil.intToByteArray(y))
                        + NKPOSUtil.byteArray2Hex(NKPOSUtil.intToByteArray(rit)) + NKPOSUtil.byteArray2Hex(NKPOSUtil.intToByteArray(riby));
                s.append(locationStr);
            }
        }
