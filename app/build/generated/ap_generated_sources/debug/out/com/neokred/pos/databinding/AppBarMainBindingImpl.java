...
public class AppBarMainBindingImpl extends AppBarMainBinding  {
    ...
    static {
        ...
        sIncludes.setIncludes(1, 
            ...
            new int[] {2},
            new int[] {com.neokred.pos.R.layout.content_main});
    ...
    private AppBarMainBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1
            , (com.neokred.pos.databinding.ContentMainBinding) bindings[2]
    ...
    public void setLifecycleOwner(@Nullable androidx.lifecycle.LifecycleOwner lifecycleOwner) {
        ...
        main.setLifecycleOwner(lifecycleOwner);
    }
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeMain((com.neokred.pos.databinding.ContentMainBinding) object, fieldId);
        }
        return false;
    }
    private boolean onChangeMain(com.neokred.pos.databinding.ContentMainBinding Main, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
