...
public final class PrintItemBinding implements ViewBinding {
  ...
  private PrintItemBinding(@NonNull LinearLayout rootView, @NonNull TextView tvPaytype) {
  ...
  public static PrintItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.tv_paytype;
      TextView tvPaytype = ViewBindings.findChildViewById(rootView, id);
      if (tvPaytype == null) {
        break missingId;
      }

      return new PrintItemBinding((LinearLayout) rootView, tvPaytype);
    }
